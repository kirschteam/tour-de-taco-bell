...
- Stops calorie-balanced to roughly 560-740 cal each, max 2 drinks per stop.
- Riders balanced to ~3,955 cal (3,270-3,525 food / 480-640 drink) and 13 items each.
